...
class Favoritegrid2ItemModel {
  Favoritegrid2ItemModel({
    ...
    image = image ?? Rx(ImageConstant.imgGroupIndianCh2);
    favorite = favorite ?? Rx(ImageConstant.imgFavoriteOnPrimary);
    learnNewSkills = learnNewSkills ?? Rx("How to become an UI/UX designer");
    circleImage = circleImage ?? Rx(ImageConstant.imgEllipse2049);
    alreadyHaveAn = alreadyHaveAn ?? Rx("Esther howards");
    alreadyHaveAn1 = alreadyHaveAn1 ?? Rx("Instructor");
    price = price ?? Rx("65.00");
    id = id ?? Rx("");
  }
